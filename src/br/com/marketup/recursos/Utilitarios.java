...
public class Utilitarios {
    ...
    public void InativaCampos(JPanel container){
        Component components[] = container.getComponents();
        for(Component component : components){
            if(component instanceof JTextField){
    ...
    public void AtivaCampos(JPanel container){
        Component components[] = container.getComponents();
        for(Component component : components){
            if(component instanceof JTextField){
    ...
    public void DesabilitaEdicao(JPanel container){
        Component components[] = container.getComponents();
        for(Component component : components){
            if(component instanceof JTextField){
    ...
    public void HabilitaEdicao(JPanel container){
        Component components[] = container.getComponents();
        for(Component component : components){
            if(component instanceof JTextField){
        ...
        if (!(verificaBackSpace(evt))) {
            if (evt.getSource() instanceof JTextField) {
                ...
                if (Character.isDigit(c)) {
                    ...
                    evt.setKeyChar((char) KeyEvent.VK_CLEAR);
                    JOptionPane.showMessageDialog(null, "Digite apenas 8 digitos numericos");
                }
            } else if (evt.getSource() instanceof JFormattedTextField) {
                int c = evt.getKeyChar();
                if (Character.isDigit(c)) {
    ...
    public static boolean validaCpf(String cpf) {
        ...
        if (cpf.equals("00000000000") ||
            ...
            JOptionPane.showMessageDialog(null, "CPF informando é invalido!");
            return false;
        }
        int d1, d2;

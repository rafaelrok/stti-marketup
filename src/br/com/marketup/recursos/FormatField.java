...
public class FormatField extends JTextField {
    ...
    public FormatField(int casasDecimais) {
    ...
    public FormatField(NumberFormat format) {// define o formato do
        // número
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(FormatField.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
    ...
    public static void main(String[] args) {
        ...
        frame.add(new FormatField(new DecimalFormat("R$ #,##0.00")) {
            {// limita a 6
                // caracteres
                setLimit(6);
            }
